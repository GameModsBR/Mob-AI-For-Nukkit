...
import br.com.gamemods.mobai.entity.attackDistanceScalingFactor
...
data class TargetFilter(
    ...
    fun test(baseEntity: Entity?, targetEntity: Entity) = when  {
        ...
        baseMaxDistance > 0.0 -> {
            val factor = if (useDistanceScalingFactor) targetEntity.attackDistanceScalingFactor else 1.0
